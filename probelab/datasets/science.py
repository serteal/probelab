...
@_register_dataset("virology_qa", Topic.SCIENCE, "Synthetic virology Q&A from abliterated model")
def virology_qa(path: str) -> Dataset:
    """Virology research Q&A generated by an abliterated model (gemma-3-27b-it).

    817 base Q/A pairs across 20 virology topics, expert-level.
